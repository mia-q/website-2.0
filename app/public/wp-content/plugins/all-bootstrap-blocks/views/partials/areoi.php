<div style="float: left; width: 400px; padding: 20px;">
   <div class="areoi-card active areoi-card-branded" style="background: #2e085e; border: none;">
      <div class="areoi-card-body">
         ...
         <h2 style="line-height: 1.4em;">The all–in–one web creation platform for marketing agencies.</h2>
         <p>AREOI empowers your team to plan, design, build and launch bespoke, agency quality WordPress websites in record time. From one unified platform.</p>
